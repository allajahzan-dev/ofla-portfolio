...
export default function AboutSection() {
    return (
        <section
            className="min-h-screen relative z-20 py-24 -mt-0.5 bg-zinc-100 flex flex-col gap-20
            rounded-b-[35px] will-change-transform overflow-hidden
            lg:py-40 xl:gap-40 lg:rounded-b-[50px]"
        >
            <div
                className="w-full px-4 grid grid-cols-1 xl:grid-cols-3 gap-10
                md:px-5 xl:px-10 xl:gap-0"
            >
                {/* Desctiption */}
                <h1
                ...
                >
                    ...
                    have been dedicated to revolutionizing the corporate landscape across
                    the UAE and Indian markets by providing exceptional office furniture
                    that combines style, functionality, and comfort.
                </h1>
                ...
                <div className="flex flex-col gap-5 justify-between">
                    <div className="flex flex-col gap-5">
                        ...
                        >
                            ...
                            solutions, and innovative design concepts that reflect the dynamic
                            business cultures of Dubai, the broader Middle East region, and
                            India&apos;s thriving corporate sector.
                        </p>
                    </div>
